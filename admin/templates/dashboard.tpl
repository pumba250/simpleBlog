...
<div class="w3-col l8 s12">
        ...
        <div class="w3-container">
            <p>Количество пользователей: <b><?= $totalUsers ?></b></p>
        <p>Количество записей в блоге: <b><?= $totalNews ?></b></p>
        <p>Количество сообщений обратной связи: <b><?= $totalFeedback ?></b></p> <!-- Полное содержание -->
            <div class="w3-row">
